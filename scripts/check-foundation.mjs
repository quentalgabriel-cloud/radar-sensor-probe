...
// nunca na StatusBarNotification em si -- por isso o listener resolve, não
// o extrator.
requireMatch(listener, /ranking\.getConversationShortcutInfo\(\)/, 'Listener deve resolver o shortcutId pela Ranking.');
